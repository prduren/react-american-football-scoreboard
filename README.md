...
- [0] Import the `useState` hook
- [0] Set up the state values for the Lions team score using the state hook
...
- [0] Set up the state value for the Tigers team score using a second state hook call
